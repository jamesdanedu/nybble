 ...
 * @param {{ stepId?: string, earlierStepIds?: Set<string> }} [ctx]
 *        The step's own id and the ids of every step before it, so a runner
 *        that references another step (freetext's `showPrior`) can be checked
 *        against the activity it actually sits in.
 */
